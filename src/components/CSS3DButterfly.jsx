        ...
        <div className="relative w-24 h-24" style={{ transformStyle: 'preserve-3d', transform: 'rotateX(55deg) rotateY(0deg) rotateZ(90deg)' }}>
          ...
          <div 
            ...
            style={{
              ...
              backgroundSize: '24px 24px', // Stretches the image to fit the dual wing boundary
              backgroundPosition: 'left center', // Forces left crop
          ...
          <div 
            ...
            style={{
              ...
              backgroundPosition: 'right center', // Forces right crop
              transformStyle: 'preserve-3d'
            }}
          />
