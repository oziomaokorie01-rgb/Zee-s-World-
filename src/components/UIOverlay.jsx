...
export default function UIOverlay() {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-between p-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {activeDistrict && (
              <button 
                ...
                className="text-xs font-mono border border-purple-500/40 px-2.5 py-1 rounded text-purple-400 bg-purple-950/20 hover:bg-purple-950 transition-colors"
              >
                Return to Orbit
              </button>
            )}
      ...
      {/* Footer Layer: System Stats + Brand Credits + Social Link Icons */}
      <footer className="w-full pointer-events-auto flex flex-col sm:flex-row justify-between items-center gap-3 text-[10px] font-mono text-neutral-500 select-none border-t border-neutral-900/40 pt-4 z-20">
        ...
        {/* Tactical Minimalist Social Media Icon Tray */}
        <div className="flex items-center gap-4">
          ...
          <a 
            ...
            className="text-neutral-500 hover:text-purple-400 active:scale-90 transition-all"
            title="X (Twitter)"
          >
